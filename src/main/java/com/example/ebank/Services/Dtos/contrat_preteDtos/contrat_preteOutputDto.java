...
public class contrat_preteOutputDto implements Serializable {
    private long id;
    private int duree;
    ...
    private DemandePostOutputDto demande;
    private String type;
    ...
    public DemandePostOutputDto getDemande() {
        return demande;
    }

    public void setDemande(DemandePostOutputDto demande) {
    ...
    public boolean equals(Object o) {
        ...
        contrat_preteOutputDto that = (contrat_preteOutputDto) o;
        return id == that.id && duree == that.duree && Double.compare(montant, that.montant) == 0 && Double.compare(mensualites, that.mensualites) == 0 && Double.compare(fraisDossier, that.fraisDossier) == 0 && Objects.equals(date_debut, that.date_debut) && Objects.equals(date_fin, that.date_fin) && Objects.equals(frequencePaiement, that.frequencePaiement) && Objects.equals(typeInteret, that.typeInteret) && Objects.equals(typeCredit, that.typeCredit) && Objects.equals(etatContrat, that.etatContrat) && Objects.equals(informationsAssurance, that.informationsAssurance) && Objects.equals(description, that.description) && Objects.equals(client, that.client) && Objects.equals(demande, that.demande) && Objects.equals(type, that.type);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, duree, date_debut, date_fin, montant, mensualites, frequencePaiement, typeInteret, typeCredit, fraisDossier, etatContrat, informationsAssurance, description, client, demande, type);
    }

    @Override
    public String toString() {
        return "contrat_preteOutputDto{" +
                "id=" + id +
                ", duree=" + duree +
